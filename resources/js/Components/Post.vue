...
const form = useForm({
    descricao: props.post.descricao,
});
    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    <span class="text-gray-800">{{ post.topico.titulo }}</span>
                    <br><span class="text-gray-800">{{ post.titulo }}</span>
                    ...
                    <p v-else class="mt-4 text-lg text-gray-900">{{ post.descricao }}</p>
                </div>
